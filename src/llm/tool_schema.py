...
Ollama-native convention). OpenAI / OpenAI-compatible / vLLM providers, however,
require JSON tool *schemas* — passing the raw function objects makes the request
body unserializable ("Object of type function is not JSON serializable").
