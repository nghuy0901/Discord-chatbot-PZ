ALTER TABLE rag_metrics ADD COLUMN IF NOT EXISTS request_id TEXT DEFAULT '';
ALTER TABLE rag_metrics ADD COLUMN IF NOT EXISTS source TEXT DEFAULT '';
ALTER TABLE rag_metrics ADD COLUMN IF NOT EXISTS query_intent TEXT;
ALTER TABLE rag_metrics ADD COLUMN IF NOT EXISTS llm_model TEXT DEFAULT '';
ALTER TABLE rag_metrics ADD COLUMN IF NOT EXISTS embedding_model TEXT DEFAULT '';
ALTER TABLE rag_metrics ADD COLUMN IF NOT EXISTS retrieval_config_version TEXT DEFAULT '';
...
ALTER TABLE rag_metrics ADD COLUMN IF NOT EXISTS prompt_tokens INT DEFAULT 0;
ALTER TABLE rag_metrics ADD COLUMN IF NOT EXISTS completion_tokens INT DEFAULT 0;
ALTER TABLE rag_metrics ADD COLUMN IF NOT EXISTS total_tokens INT DEFAULT 0;
ALTER TABLE rag_metrics ADD COLUMN IF NOT EXISTS estimated_cost_usd FLOAT DEFAULT 0;
ALTER TABLE rag_metrics ADD COLUMN IF NOT EXISTS cache_hit BOOLEAN DEFAULT FALSE;
