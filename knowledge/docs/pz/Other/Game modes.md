...
It also teaches the player about yelling, a mechanic that allows drawing zombies , tricking the player into pressing Q , ultimately killing the player and ending the tutorial. Whilst it is possible to flee from the horde and lose them in the trees, there is no way to get through the fencing around the tutorial map and only a limited supply of food, so death is inevitable.
...
Likes a challenge, with more focus on combat familiar to players of earlier builds. Survivor mode weakens zombies by lowering their strength and preventing them from dragging down players. Survivor mode strengthens players by decreasing rear vulnerability, and allowing the player to hit and push multiple zombies at once when using some melee weapons by enabling the weapon multi-hit option.

### Builder

"Construction, Exploration and Farming focus. A more relaxed experience."
Likes a more relaxing experience of building, looting and farming, and less zombie focus. There are far fewer zombies, with a population 20% of the standard. These zombies are also substantially weaker with weakened senses, decreased strength and toughness, and no drag down ability. To make up for the weaker zombies, almost all loot is rarer, except food, and player stats and clothing degrade faster, requiring more materials to keep the character afloat.
...
This challenge was removed from the game as of Build 42 unstable.
...
[Our thanks to Community mapper BobHeckling for recreating the old 0.1.5a map with the current PZ toolset.]
...
Be ready for them. 
 This challenge was removed from the game as of Build 41 . It could be brought back to the game by installing Return of Opening Hours Challenge mod created by Authentic Peach.
