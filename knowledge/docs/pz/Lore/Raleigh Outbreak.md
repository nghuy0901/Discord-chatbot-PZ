...
The Raleigh Outbreak might have also affected livestock along with humans, creating the impression of a similar disease heavily publicized during the 1980s and 1990s, mad cow disease , which can cause humans to develop variant Creutzfeldt-Jakob disease ; slowly deteriorating their nervous system, resulting in cognitive decline, and physical disability, slightly similar to the Knox Infection . As seen on WBLN news, the player can hear a concerned person talking about their wife, the CDC response, and how it only affects livestock (even though the person mentioned that their wife had died because of it, though it was likely a cross-species infection).
...
The virus at the heart of the Raleigh Outbreak, the "EVNA Infection", either spreads through means like Mad Cow or similar to the Knox Infection through influenza-like means. From an excerpt from the VHS, "Shows", it is known that the infection is 'flesh-eating', meaning it might be bacterial-like necrotizing fasciitis . The infection was confirmed to kill one person, the wife of Iain Sweetman, a guest on the WBLN. The outbreak infected many more, and the infection was labeled "Fatal". With the event being told in the past tense, it can be assumed the CDC's efforts were successful in stopping the outbreak, even with the casualties.

## Origin

The Raleigh Outbreak may have been accidentally been made/spread by Spiffo's , as heard on the Secrets of Spiffo's Special Sauce Home VHS , considering the name, it is likely that Spiffo Corporation is responsible for this. Note that this is when Spiffo has become international, being within the boundaries of the former Soviet Union, England, and China.

Below is a transcript from the Home VHS mentioned.

Conspiracy Theorist : And yet the Spiffo's Corporation has a secret it just won't tell anyone 
...
There is also a Home VHS tape that also mentions the Raleigh Outbreak (does not involve the name, although it is given a new name, the EVNA virus.), " Shows " . Here is an extract.

Richard Gershwin : Fatal illness continues to spread through the community. 
...
- Knox Event
- Secrets of Spiffo's Special Sauce
- Shows
- WBLN News
