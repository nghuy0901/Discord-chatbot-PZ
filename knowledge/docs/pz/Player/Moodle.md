...
This moodle represents the character's stress from a variety of circumstances, chief among them are the fear of infection and the smoker trait. Accumulated stress negatively impacts combat ability, and chronic stress can lead to unhappiness . Stress can be managed through consumables such as cigarettes or by reading literature .
...
The restricted movement moodle indicates the character is unable to sprint due to being barefoot, having leg injuries, being overloaded , wearing heavy clothes, or suffering from moodles that impact speed.
...
A gas mask or full suit can help reduce or prevent the effects of noxious smells.
...
- Concentrating moodle icon added in Build 42 , currently unavailable
- 32px Concentrating moodle icon added in Build 42, currently unavailable
- Dizzy moodle icon added in Build 42, currently unavailable
- 32px Dizzy moodle icon added in Build 42, currently unavailable
- Exhausted moodle icon added in Build 42, currently unavailable
- 32px Exhausted moodle icon added in Build 42, currently unavailable
- Happy moodle icon added in Build 42, currently unavailable
- 32px Happy moodle icon added in Build 42, currently unavailable
- Scared moodle icon added in Build 42, currently unavailable
- 32px Scared moodle icon added in Build 42, currently unavailable
- HearingImpaired moodle (status) icon added in Build 42, currently unavailable
- 32px HearingImpaired moodle (status) icon added in Build 42, currently unavailable
- Sedated moodle (status) icon added in Build 42, currently unavailable
- 32px Sedated moodle (status) icon added in Build 42, currently unavailable
- VisionImpaired moodle (status) icon added in Build 42, currently unavailable
- 32px VisionImpaired moodle (status) icon added in Build 42, currently unavailable
- Wired moodle (status) icon added in Build 42, currently unavailable
- 32px Wired moodle (status) icon added in Build 42, currently unavailable
- Old moodles "good 1" background
- Old moodles "good 2" background
- Old moodles "good 3" background
- Old moodles "bad 1" background
- Old moodles "bad 2" background
- Old moodles "bad 3" background
- Old moodles "bad 4" background
