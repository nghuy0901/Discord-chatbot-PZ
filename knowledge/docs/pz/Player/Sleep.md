...
category: Player
type: Sleep
source_url: https://pzwiki.net/wiki/Sleep
scraped_at: 2026-02-24 16:24:01
...
Unlike zombies , the player needs to sleep . When the player needs to sleep, the tired moodle will show up on the screen. To sleep, the player needs to find a bed, sofa, or other chair . Or, if the player is tired enough, even the floor will do. A player can also sleep in a tent or vehicle .
...
- ≈9 hours a day.
- ≈6 hours a day if the wakeful trait is selected.
- ≈12 hours a day if the sleepyhead trait is selected.

Sleeping time can be induced by using sleeping tablets . Sleeping tablets can also induce the need to sleep when the player is otherwise unable to (e.g., experiencing pain).
...
Bed quality can further be improved by placing pillow on it.
